...
class MobileNetV3_InvertedResidual_SFEB_RAB(BaseBackbone):
    ...
    arch_settings = {
        'small': [[3, 16, 16, True, 'ReLU', 2],#0
                  [3, 72, 24, False, 'ReLU', 2],#1
                  [3, 88, 24, False, 'ReLU', 1],#2
                  [5, 96, 40, True, 'HSwish', 2],#3
                  [5, 240, 40, True, 'HSwish', 1],#4
                  [5, 240, 40, True, 'HSwish', 1],#5
                  [5, 120, 48, True, 'HSwish', 1],#6
                  [5, 144, 48, True, 'HSwish', 1],#7
                  [5, 288, 96, True, 'HSwish', 2],#8
                  [5, 576, 96, True, 'HSwish', 1],#9
                  [5, 576, 96, True, 'HSwish', 1]],#10
    ...
    def _make_layer(self):
        ...
        for i, params in enumerate(layer_setting):
            ...
            if with_se:
                ...
                se_cfg = None
            use_wtconv_layers=[0,1,2]
            use_MSGDC_layers=[5,9]
            if i in use_wtconv_layers:
                block=InvertedResidual_SFEB
