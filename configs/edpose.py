...
from mmpose.datasets import (BottomupRandomChoiceResize, BottomupRandomCrop,
                             Cow16Dataset, LoadImage, PackPoseInputs,
                             RandomFlip)
...
# runtime
train_cfg.update(max_epochs=200, val_interval=10)  # noqa
...
# codec settings
codec = dict(type=EDPoseLabel, num_select=50, num_keypoints=16)
...
dataset_type = Cow16Dataset
data_mode = 'bottomup'
data_root = 'data/lastest/'
